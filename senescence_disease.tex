...
\def\Authors{Anyela V Camargo\,$^{1,*}$, Jan T Kim\,$^{{2}}$, Alison Bentley\,$^{{3,*}}$}
...
$^{3}$ The John Bingham Laboratory, NIAB, UK\\ $^{2}$ The Pirbright Institute, UK}
% The Corresponding Author should be marked with an asterisk
% Provide the exact contact address (this time including street name and city zip code) and email of the corresponding author
\def\corrAuthor{Alison Bentley}
\def\corrAddress{The John Bingham Laboratory, NIAB, UK}
\def\corrEmail{alison.bentley@niab.com}
...
\begin{table}[ht]
 \textbf{\refstepcounter{table}\label{table:qtl} Table \arabic{table}.}{ logP is -log$_{10}$ (ANOVA P-value) at the QTL peak; chr is the chromosome}\\
\input{qtltable.tex}
\end{table}
